...
export default function TeamCard({ member: { alt, name, photoLg, position, linkedin, slug }, index }) {
  return (
    <>
      <Tooltip id={ `team-card-${index}` } className="team-tooltip" />
      <div className="col">
        <div
        ...
        >
          ...
          >
            <img
              data-tooltip-id={ `team-card-${index}` }
              data-tooltip-content={ `${name} profile` }
              alt={ alt }
              loading="lazy"
