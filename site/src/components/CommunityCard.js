...
export default function CommunityCard({ member: { alt, name, photoLg, position, linkedin } }) {
  return (
    <div data-tip={ position } className="col-auto d-flex flex-column justify-content-center align-items-center">
      <ReactTooltip offset="{'top': 10, 'left': 10}" className="tooltip" />
      <div
